...
public class User implements Serializable {
    ...
    public User(String userId, String firstName, String lastName, String username, String email, String password, Date joinDate, LocalDate now, LocalDate now1, String role, boolean b) {
        this.userId = userId;
        this.firstName = firstName;
        this.lastName = lastName;
        this.username = username;
